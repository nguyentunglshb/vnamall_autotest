...
WebUI.setText(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_S in thoi_phone'), '0987776754')

WebUI.click(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_a ch c th_address'))

WebUI.setText(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_a ch c th_address'), '#')
