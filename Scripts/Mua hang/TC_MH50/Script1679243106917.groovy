...
WebUI.setText(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_Email_email'), '123')

WebUI.setText(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_S in thoi_phone'), '0988776655')
