...
WebUI.setText(findTestObject('Object Repository/Page_Almira - B baby trng size trung/input_S in thoi_phone'), '   ')

WebUI.setText(findTestObject('Object Repository/Page_Almira - B baby trng size trung/input_a ch c th_address'), 'e')
