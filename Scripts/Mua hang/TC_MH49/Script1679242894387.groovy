...
WebUI.doubleClick(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_H_firstName'))
...
WebUI.setText(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_Email_email'), 'daylaemail')

WebUI.setText(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_S in thoi_phone'), '0987777654')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/select_PhngXPhng Phc XPhng Ging VPhng Kim M_4e68c3'), 
    '100100001', true)
