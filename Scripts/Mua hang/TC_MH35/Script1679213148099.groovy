...
WebUI.setText(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_S in thoi_phone'), '1234567890')

WebUI.setText(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_a ch c th_address'), 'a')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/select_PhngXTh trn Sc SnX Tin DcX Vit LongX_e61fe6'), 
    '101600412', true)

WebUI.click(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_S in thoi_phone'))

WebUI.click(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/div_Thng tin giao hngVui lng in y  thng tin_405175'))
