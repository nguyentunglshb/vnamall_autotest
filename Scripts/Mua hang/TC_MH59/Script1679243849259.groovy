...
WebUI.setText(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/input_Email_email'), '<script>destroyWebsite();</script>')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Diamond - Gi hoa nhp khu/select_PhngXPhng Phc TnPhng Phan Chu TrinhP_ceaabf'), 
    '100200085', true)
