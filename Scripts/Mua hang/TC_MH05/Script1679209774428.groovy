...
WebUI.click(findTestObject('Object Repository/Page_Hilary (sweet bouqet) - B hoa mix/div_H'))

WebUI.setText(findTestObject('Object Repository/Page_Hilary (sweet bouqet) - B hoa mix/input_H_firstName'), 'ⓐ')

WebUI.setText(findTestObject('Object Repository/Page_Hilary (sweet bouqet) - B hoa mix/input_Tn_lastName'), 'nguyen')

WebUI.setText(findTestObject('Object Repository/Page_Hilary (sweet bouqet) - B hoa mix/input_Email_email'), 'nt@gmail.com')

WebUI.setText(findTestObject('Object Repository/Page_Hilary (sweet bouqet) - B hoa mix/input_S in thoi_phone'), '0987866655')

WebUI.setText(findTestObject('Object Repository/Page_Hilary (sweet bouqet) - B hoa mix/input_a ch c th_address'), 'khong')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Hilary (sweet bouqet) - B hoa mix/select_QunHuynQun Cm LQun Hi ChuQun Lin Chi_9e8d2e'), 
    '48495', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Hilary (sweet bouqet) - B hoa mix/select_PhngXPhng Khu TrungPhng Ha PhtPhng H_570551'), 
    '4849520306', true)

WebUI.click(findTestObject('Object Repository/Page_Hilary (sweet bouqet) - B hoa mix/button_Tin hnh n phng thc thanh ton'))

WebUI.click(findTestObject('Object Repository/Page_Hilary (sweet bouqet) - B hoa mix/svg_Hilary (sweet bouqet) - B hoa mix_MuiSv_b685b8'))
