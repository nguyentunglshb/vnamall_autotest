...
WebUI.setText(findTestObject('Object Repository/Page_Almira - B baby trng size trung/input_H_firstName'), 'tung')
...
WebUI.setText(findTestObject('Object Repository/Page_Almira - B baby trng size trung/input_S in thoi_phone'), '0987776655')

WebUI.setText(findTestObject('Object Repository/Page_Almira - B baby trng size trung/input_a ch c th_address'), 'ko')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Almira - B baby trng size trung/select_PhngXPhng Phc TnPhng Phan Chu TrinhP_ceaabf'), 
    '100200037', true)
