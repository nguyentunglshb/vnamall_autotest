...
WebUI.setText(findTestObject('Object Repository/Page_Almira - B baby trng size trung/input_H_firstName'), '')
...
WebUI.setText(findTestObject('Object Repository/Page_Almira - B baby trng size trung/input_S in thoi_phone'), '0987776789')
...
WebUI.click(findTestObject('Object Repository/Page_Almira - B baby trng size trung/div_Thng tin giao hngVui lng in y  thng tin_405175'))
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Almira - B baby trng size trung/select_PhngXPhng Nguyn DuPhng Cu DnPhng Bch_12db8c'), 
    '100700256', true)
