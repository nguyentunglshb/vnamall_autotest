...
WebUI.setText(findTestObject('Object Repository/Page_Scarlet (sweet box) - box hoa mix/input_S in thoi_phone'), '0987776655')
...
WebUI.click(findTestObject('Object Repository/Page_Scarlet (sweet box) - box hoa mix/svg_Scarlet (sweet box) - box hoa mix_MuiSv_e55de1'))
